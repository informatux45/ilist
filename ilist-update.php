...
require dirname(__FILE__) . '/vendor/Puc/v4p11/Autoloader.php';
new Puc_v4p11_Autoloader();

require dirname(__FILE__) . '/vendor/Puc/v4p11/Factory.php';
require dirname(__FILE__) . '/vendor/Puc/v4/Factory.php';
